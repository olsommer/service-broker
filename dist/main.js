var $6mCEl$child_process = require("child_process");
var $6mCEl$axios = require("axios");
var $6mCEl$supabaserealtimejs = require("@supabase/realtime-js");
var $6mCEl$supabasesupabasejs = require("@supabase/supabase-js");
var $6mCEl$openai = require("openai");
...
const $1d768b6ca5759317$var$rturl = "wss://ndxhivyksquaghuolyig.supabase.co/realtime/v1";
// wss://[project-ref].supabase.co/realtime/v1/websocket?apikey=[anon-token]&log_level=info&vsn=1.0.0
const $1d768b6ca5759317$var$url = "https://ndxhivyksquaghuolyig.supabase.co";
const $1d768b6ca5759317$var$key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5keGhpdnlrc3F1YWdodW9seWlnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY5MjI3NjEyNywiZXhwIjoyMDA3ODUyMTI3fQ.hRHgz6ZomMHf7RlKUp1JeoYx0frcvqELHxof4GN9RRk";
if (!$1d768b6ca5759317$var$url) throw new Error("Missing url");
if (!$1d768b6ca5759317$var$key) throw new Error("Missing service role key");
const $1d768b6ca5759317$export$ea80eb855ab064f8 = new (0, $6mCEl$supabaserealtimejs.RealtimeClient)($1d768b6ca5759317$var$rturl, {
    params: {
        apikey: $1d768b6ca5759317$var$key,
        reconnect: true
    }
});
const $1d768b6ca5759317$export$e40e0db08f6c644f = (0, $6mCEl$supabasesupabasejs.createClient)($1d768b6ca5759317$var$url, $1d768b6ca5759317$var$key);


async function $7ea8d8c9a05decae$export$bef1f36f5486a6a3(status, meta, id, task) {
    const { error: error } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("leads_jobs_logs").insert({
        status: status,
        meta: meta,
        ref_id: id,
        task: task
...
function $5913ce25e18d6c2b$export$bef94a5618bf18bf(url) {
    const urlPattern = /^(https?:\/\/)?([a-zA-Z0-9.-]+)(:[0-9]+)?(\/[^\s]*)?$/;
    return urlPattern.test(url);
}


function $d27a3638ad98a7a0$export$f784c93c2c19988(inputUrl) {
...
async function $83d829005838f282$export$6c0ecc2862ebf379(record) {
    ...
    try {
        ...
        // Get lead data
        // --------------------------------------
        const { data: leadData, error: leadErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("leads").select("*").eq("id", lead_id).limit(1).single();
        ...
        // Transform url
        // -------------------------------------------------
        if ((0, $5913ce25e18d6c2b$export$bef94a5618bf18bf)(url) === false) await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("ERROR", "result: invalid url", id, "scrape");
        const tUrl = (0, $d27a3638ad98a7a0$export$f784c93c2c19988)(url);
        // Scraping job
        // -------------------------------------------------
        ...
        // -------------------------------------------------
        (0, ($parcel$interopDefault($6mCEl$axios))).post(reqURL, body, {
            headers: {
                "Content-Type": "application/json"
            }
        }).then(async (res)=>{
            await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("OK", res, id, "scrape");
            //
            //
            // Add dummy scrape but without any content
            const { error: error } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("scrapes").insert({
                id: uuid,
                lead_job_id: id,
                log_request: res,
    ...
    /* Error handling */ } catch (error) {
        await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("ERROR", error.message, id, "scrape");
    }
}
...
const $1f69cd2c02ed1be6$export$464f99bcbd6e7094 = new (0, ($parcel$interopDefault($6mCEl$openai)))({
...
async function $27ab47e5cfcf0515$export$5a8b80f35baeb72c(id, status, tries) {
    const { error: error } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("leads_jobs").update({
        status: status,
        tries: tries
    }).eq("id", id);
    if (error) throw error;
    await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("OK", status, id, "next state");
}


async function $2b950e46116ec288$export$1e70e29ad6d71f19(record) {
    const { id: id, job_id: job_id } = record;
    try {
        if (!job_id) throw new Error("No job id");
        // Get form data
        // --------------------------------------
        const { data: scrData, error: scrErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("scrapes").select("*").eq("lead_job_id", id).order("created_at", {
            ascending: false
        }).limit(1).single();
        ...
        // Get job data
        // --------------------------------------
        const { data: jobsData, error: jobsErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("jobs").select("*").eq("id", job_id).limit(1).single();
      ...
      Write a summary of a company based on the aboved scraped website. ${focusPrompt}
       ...
       `;
        //
        const chatCompletion = await (0, $1f69cd2c02ed1be6$export$464f99bcbd6e7094).chat.completions.create({
            messages: [
                {
                    role: "user",
                    content: prompt
        ...
        // --------------------------------------
        const { error: error } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("summaries").insert({
            content: summary,
            meta: meta,
            type: "HOMEPAGE",
            lead_job_id: id
        ...
        if (error) throw error;
        await (0, $27ab47e5cfcf0515$export$5a8b80f35baeb72c)(id, "FLAG_TO_GENERATE");
    } catch (error) {
        console.log(error);
        await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("ERROR", error.message, id, "summarize");
    }
}
...
async function $9e5d8ed27e673884$export$80d376111cc09ad7(record) {
    ...
    try {
        ...
        // Get summary data
        // --------------------------------------
        const { data: sumData, error: sumErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("summaries").select("*").eq("lead_job_id", id).order("created_at", {
            ascending: false
        }).limit(1).single();
    ...
    `;
        ...
        // --------------------------------------
        const { error: error } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("lines").insert({
        ...
        if (error) throw error;
        await (0, $27ab47e5cfcf0515$export$5a8b80f35baeb72c)(id, "FLAG_TO_FINISH");
    } catch (error) {
        console.error(error);
        await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("ERROR", error.message, id, "generate");
    }
}
...
async function $1ca20a9136d54ec4$export$d87cfcc979a5825c(props) {
    ...
    const { data: billData, error: billErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("billings").update({
    ...
    // Get current credits
    const { data: rlData, error: rlErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("ratelimits").select("credits").eq("id", job_id).limit(1).single();
    ...
    const { error: bill2Err } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("ratelimits").update({
        credits: newCreditAmount
    }).eq("id", user_id);
    if (bill2Err) throw bill2Err;
    await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("OK", {
...
async function $5ce7f7af74c2dedf$export$5953b28951b32649(record) {
    const { id: id, lead_id: lead_id, job_id: job_id } = record;
    try {
        ...
        // Get job data
        // --------------------------------------
        const { data: jobData, error: jobErr } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("jobs").select("*").eq("id", job_id).limit(1).single();
        ...
        if (count_errors + count_gen_lines === count_file_rows) {
            // Update job data
            // --------------------------------------
            const { error: job3Err } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("jobs").update({
                status: "DONE",
                count_gen_lines: count_gen_lines
            }).eq("id", job_id);
            if (job3Err) throw job3Err;
            // If Pro job, create billing
            if (jobData.product == "PRO") await (0, $1ca20a9136d54ec4$export$d87cfcc979a5825c)({
                job_id: job_id,
                count_gen_lines: count_gen_lines,
            ...
            // Update job data
            // --------------------------------------
            const { error: job2Err } = await (0, $1d768b6ca5759317$export$e40e0db08f6c644f).from("jobs").update({
                count_gen_lines: count_gen_lines
            }).eq("id", job_id);
        ...
        // Set the next state
        // --------------------------------------
        await (0, $27ab47e5cfcf0515$export$5a8b80f35baeb72c)(id, "DONE");
    } catch (error) {
        console.log(error);
        await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("ERROR", error.message, id, "finish");
    }
}


async function $c63c409014c4d054$export$8f34ce051745d39e(payload) {
    console.log(payload);
    let id = "";
    try {
        ...
        switch(record.status){
            case "FLAG_TO_SCRAPE":
                await (0, $83d829005838f282$export$6c0ecc2862ebf379)(record);
                break;
            case "FLAG_TO_SUMMARIZE":
                await (0, $2b950e46116ec288$export$1e70e29ad6d71f19)(record);
                break;
            case "FLAG_TO_GENERATE":
                await (0, $9e5d8ed27e673884$export$80d376111cc09ad7)(record);
                break;
            case "FLAG_TO_FINISH":
                await (0, $5ce7f7af74c2dedf$export$5953b28951b32649)(record);
                break;
            case "DONE":
                break;
            case "FLAG_TO_RETRY":
        ...
        await (0, $7ea8d8c9a05decae$export$bef1f36f5486a6a3)("ERROR", error.message, id, "task_manager");
    }
}


const $3f2a3bb44e040fdf$export$94672d1f46a84401 = (payload)=>{
    const payloadString = JSON.stringify(payload);
    const child = (0, $6mCEl$child_process.spawn)("node", [
        "-e",
        `(${(0, $c63c409014c4d054$export$8f34ce051745d39e).toString()})(JSON.parse('${payloadString}'))`
    ], {
        cwd: process.cwd(),
        detached: true,
        stdio: "inherit"
...
const $f2e2349b634bbdaf$var$channel = (0, $1d768b6ca5759317$export$ea80eb855ab064f8).channel("#id");
$f2e2349b634bbdaf$var$channel.on("postgres_changes", {
    event: "*",
    schema: "public",
    table: "leads_jobs"
}, (payload)=>(0, $3f2a3bb44e040fdf$export$94672d1f46a84401)(payload));
$f2e2349b634bbdaf$var$channel.subscribe((status, err)=>{
